...
<template>
  <div class="flex h-screen overflow-hidden bg-gray-50 text-slate-800 font-sans">
        ...
        <div v-if="isProfileOpen" class="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm relative z-10 overflow-hidden">
                ...
                <div class="p-4 space-y-2">
                    ...
                    <button @click="isLoggedIn = false; closeModal()" class="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-red-50 text-red-600 transition-colors">
